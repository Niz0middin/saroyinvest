...
<div id="fh5co-counter" class="fh5co-counters" style="background-image: url(img/a2/4.jpg)" data-stellar-background-ratio="0.5">
    <div class="overlay"></div>
    <div class="container">
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6 text-center animate-box"><span class="icon"><i class="fa fa-map-o"></i></span> <span class="fh5co-counter" style="font-size: 23px; line-height: 1.8">17, Algoritm, Tashkent</span> <span class="fh5co-counter-label">Адрес</span></div>
                </div>
            </div>
        </div>
    </div>
...
<div id="fh5co-gallery" class="fh5co-bg-section">
    ...
    <div class="row">
        <div class="col-md-3 col-padded"><a href="#" class="gallery" style="background-image: url(img/a2/1.jpg)" onclick="openModal();currentSlide(1)"></a></div>
        <div class="col-md-3 col-padded"><a href="#" class="gallery" style="background-image: url(img/a2/2.jpg)" onclick="openModal();currentSlide(2)"></a></div>
        <div class="col-md-3 col-padded"><a href="#" class="gallery" style="background-image: url(img/a2/3.jpg)" onclick="openModal();currentSlide(3)"></a></div>
        <div class="col-md-3 col-padded"><a href="#" class="gallery" style="background-image: url(img/a2/4.jpg)" onclick="openModal();currentSlide(4)"></a></div>
        <div class="col-md-3 col-padded"><a href="#" class="gallery" style="background-image: url(img/a2/5.jpg)" onclick="openModal();currentSlide(5)"></a></div>
    </div>
...
<span class="close cursor" onclick="closeModal()">&times;</span>
        ...
        <div class="modal-content">
            <div class="mySlides">
                ...
                <img src="img/a2/1.jpg" style="width:100%">
</div>
                <div class="mySlides">
                    <div class="numbertext">2 / 5</div>
                    <img src="img/a2/2.jpg" style="width:100%">
</div>
                    <div class="mySlides">
                        <div class="numbertext">3 / 5</div>
                        <img src="img/a2/3.jpg" style="width:100%">
</div>
                        <div class="mySlides">
                            <div class="numbertext">4 / 5</div>
                            <img src="img/a2/4.jpg" style="width:100%">
</div>
                            <div class="mySlides">
                                <div class="numbertext">5 / 5</div>
                                <img src="img/a2/5.jpg" style="width:100%">
</div>
